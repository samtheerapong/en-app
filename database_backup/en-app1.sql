...
--
-- Host: localhost:3306
-- Generation Time: Dec 12, 2023 at 01:11 AM
...
INSERT INTO `department` (`department_id`, `code`, `name`, `detail`, `department_head`, `color`, `active`) VALUES
...
(12, 'IT', 'แผนกเทคโนโลยีสารสนเทศ (IT)', NULL, 12, '#186F65', 1),
(13, 'SA', 'ฝ่ายขาย (Sale)', NULL, 6, '#C70039', 1),
(14, 'SP', 'แผนกสนับสนุน (Support)', NULL, 9, '#219C90', 1);
...
INSERT INTO `en_category` (`category_id`, `code`, `name`, `detail`, `color`, `avtive`) VALUES
...
INSERT INTO `en_priority` (`priority_id`, `code`, `name`, `detail`, `color`, `avtive`) VALUES
...
--
-- Table structure for table `en_req_approve`
--

CREATE TABLE `en_req_approve` (
...
CREATE TABLE `en_team` (
  ...
  `technician2` varchar(255) DEFAULT NULL,
  `technician3` varchar(255) DEFAULT NULL,
  `technician4` varchar(255) DEFAULT NULL,
  `technician5` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `en_type`
--
...
--
-- Dumping data for table `en_type`
--

INSERT INTO `en_type` (`type_id`, `code`, `name`, `detail`, `color`, `avtive`) VALUES
(1, 'Repair', 'งานซ่อม', NULL, '#C70039', 1),
(2, 'Project', 'งานโครงการ', NULL, '#0174BE', 1);
...
INSERT INTO `en_urgency` (`urgency_id`, `code`, `name`, `detail`, `color`, `avtive`) VALUES
(1, 'Not urgent', 'ไม่รีบ', NULL, '#F2BED1', 1),
(2, 'Normal', 'ปกติ', NULL, '#025464', 1),
(3, 'Urgent', 'ด่วน', NULL, '#F86F03', 1),
(4, 'Most urgent', 'ด่วนที่สุด', NULL, '#FE0000', 1);
...
CREATE TABLE `en_wo` (
  ...
  `list_id` int(11) DEFAULT NULL COMMENT 'ราการซ่อม',
  `work_date` date DEFAULT NULL COMMENT 'วันที่',
  `machine` int(11) DEFAULT NULL COMMENT 'เครื่องจักร',
  ...
  `work_detail` text COMMENT 'รายละเอียดงาน',
  ...
  `recheck_mechanics` int(11) DEFAULT NULL COMMENT 'ตรวจเครื่องกลหลังซ่อม',
...
INSERT INTO `location` (`location_id`, `code`, `name`, `detail`, `color`, `active`) VALUES
(1, 'B1', 'อาคาร B1', NULL, NULL, 1),
(2, 'B2', 'อาคาร B2', NULL, NULL, 1),
(3, 'B3', 'อาคาร B3', NULL, NULL, 1),
(4, 'B4', 'อาคาร B4', NULL, NULL, 1);
...
--
-- Indexes for table `en_req_approve`
--
ALTER TABLE `en_req_approve`
...
ALTER TABLE `en_rp`
  ...
  ADD KEY `fk_enrequest_job_status1_idx` (`status`),
...
ALTER TABLE `en_wo`
  ...
  ADD KEY `fk_en_work_order_en_technician1_idx` (`rechecker`),
  ADD KEY `fk_en_work_order_en_technician2_idx` (`checker`),
...
--
-- AUTO_INCREMENT for table `en_req_approve`
--
ALTER TABLE `en_req_approve`
...
--
-- AUTO_INCREMENT for table `en_type`
--
ALTER TABLE `en_type`
...
--
ALTER TABLE `en_urgency`
  MODIFY `urgency_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `en_wo`
--
ALTER TABLE `en_wo`
  MODIFY `workorder_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `en_rp`
  ADD CONSTRAINT `fk_en_request_en_department10` FOREIGN KEY (`department`) REFERENCES `department` (`department_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_en_request_en_priority0` FOREIGN KEY (`priority`) REFERENCES `en_priority` (`priority_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_en_request_en_status10` FOREIGN KEY (`status`) REFERENCES `en_status` (`status_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_en_request_en_urgency10` FOREIGN KEY (`urgency`) REFERENCES `en_urgency` (`urgency_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `en_rp_list`
--
ALTER TABLE `en_rp_list`
  ADD CONSTRAINT `fk_en_request_list_en_location1` FOREIGN KEY (`location`) REFERENCES `location` (`location_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `en_wo`
--
ALTER TABLE `en_wo`
  ADD CONSTRAINT `fk_en_work_order_en_category1` FOREIGN KEY (`category_id`) REFERENCES `en_category` (`category_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_en_work_order_en_technician1` FOREIGN KEY (`rechecker`) REFERENCES `en_technician` (`technician_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_en_work_order_en_technician2` FOREIGN KEY (`checker`) REFERENCES `en_technician` (`technician_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_en_work_order_en_type1` FOREIGN KEY (`work_type_id`) REFERENCES `en_type` (`type_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `en_wo_list`
--
ALTER TABLE `en_wo_list`
  ADD CONSTRAINT `fk_en_wo_list_en_wo1` FOREIGN KEY (`workorder_id`) REFERENCES `en_wo` (`workorder_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
