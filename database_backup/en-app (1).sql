...
--
-- Host: localhost:3306
-- Generation Time: Dec 11, 2023 at 03:26 PM
...
CREATE TABLE `en_wo` (
  ...
  `list_id` int(11) DEFAULT NULL COMMENT 'รายการซ่อม',
...
ALTER TABLE `en_wo`
  ...
  ADD KEY `fk_en_wo_en_machine1_idx` (`machine`);
...
ALTER TABLE `en_rp`
  ...
  ADD CONSTRAINT `fk_en_request_en_status10` FOREIGN KEY (`status`) REFERENCES `en_status` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `en_wo`
  ADD CONSTRAINT `fk_en_wo_en_machine1` FOREIGN KEY (`machine`) REFERENCES `en_machine` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  ADD CONSTRAINT `fk_en_work_order_en_technician1` FOREIGN KEY (`rechecker`) REFERENCES `en_technician` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_en_work_order_en_technician2` FOREIGN KEY (`checker`) REFERENCES `en_technician` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_en_work_order_en_type1` FOREIGN KEY (`work_type_id`) REFERENCES `en_type` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
