...
--
-- Host: localhost:3306
-- Generation Time: Dec 11, 2023 at 08:22 AM
...
INSERT INTO `en_status` (`status_id`, `code`, `name`, `detail`, `color`, `avtive`) VALUES
...
ALTER TABLE `en_req_approve`
  ...
  ADD KEY `fk_en_req_approve_en_request1_idx` (`request_id`);
...
ALTER TABLE `en_rp_list`
  ...
  ADD KEY `fk_en_request_list_en_request1_idx` (`request_id`),
...
--
ALTER TABLE `en_urgency`
  MODIFY `urgency_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- Constraints for table `en_req_approve`
--
ALTER TABLE `en_req_approve`
  ADD CONSTRAINT `fk_en_req_approve_en_request1` FOREIGN KEY (`request_id`) REFERENCES `en_rp` (`request_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `en_rp_list`
  ...
  ADD CONSTRAINT `fk_en_request_list_en_request1` FOREIGN KEY (`request_id`) REFERENCES `en_rp` (`request_id`) ON DELETE CASCADE ON UPDATE CASCADE;
